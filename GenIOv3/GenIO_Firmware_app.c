...
/*                        
                    case 0x82:
                        if (appData.hidDataTransmitted) {   //Validar que el EP_IN puede recibir información que eventualmente será leída por la computadora
                            appData.transmitDataBuffer[0]=0x82;
                            appData.transmitDataBuffer[1]='L';
                            appData.transmitDataBuffer[2]='u';
                            appData.transmitDataBuffer[3]='i';
                            appData.transmitDataBuffer[4]='s';
                            appData.transmitDataBuffer[5]=' ';
                            appData.transmitDataBuffer[6]='R';
                            appData.transmitDataBuffer[7]='i';
                            appData.transmitDataBuffer[8]='c';
                            appData.transmitDataBuffer[9]='a';
                            appData.transmitDataBuffer[10]='r';
                            appData.transmitDataBuffer[11]='d';
                            appData.transmitDataBuffer[12]='o';
...
//                            appData.transmitDataBuffer[4]=((dato2>>24) & 0x0FF);//b31-b24
                    ...
                    case 0x10:  //Suma [0] -->0x10
                        ...
                        appData.state = APP_STATE_MAIN_TASK;        
                        break;
                    case 0x11:  //Resta ints
                        break;
                    case 0x12:  //Multiplicación ints
                        break;
                    case 0x13:  //División ints
                        break;
                    case 0x20:  //Suma floats
                                //     [0] -->0x20
                                //     [1] -->dato1[b7-b0]
                                //     [2] -->dato1[b15-b8]
                                //     [3] -->dato1[b23-b16]
                        ...
                        if (appData.hidDataTransmitted) {   //Validar que el EP_IN puede recibir información que eventualmente será leída por la computadora
                            ...
                            //----Obtener los operandos que han sido recibidos en el EP_OUT
                            //datof1Ptr=(float *)appData.receiveDataBuffer[1];  <--Esta era la intenci�n, pero la memoria de appData est� protegida y no puedo usar apuntadores para accederla
                            ...
                            datof1=*datof1Ptr;
                            datof2=*datof2Ptr;
                            respuestaf = datof1 + datof2;   //(*datof1Ptr) + (*datof2Ptr)
                            //respuestafPtr=(float *)&appData.transmitDataBuffer[1]; <--Esta era la intenci�n, pero la memoria de appData est� protegida y no puedo usar apuntadores para accederla
